...
function Register() {
    ...
    const [inputs, setInputs] = useState({ avatar: '' });
    ...
    const handleSubmit = (event) => {
        ...
        fetch("https://www.melivecode.com/api/users/create", requestOptions)
            ...
            .then(result => {
                if (result.status === 'ok') {
                    MySwal.fire({
                        html: <i>Registration completed!</i>,
                        icon: 'success'
                    }).then(() => {
                        navigate('/')
                    });
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6" action="#" method="POST">
                                ...
                                <div>
                                    <div className="flex items-center justify-between">
                                        <label htmlFor="password" className="px-3 block text-sm font-medium leading-6 text-gray-900">
                                            Password
                                        </label>
                                    </div>
                                    <div className="mt-2">
